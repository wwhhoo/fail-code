...
def get_cand( faiss_I, query, OPQquery, PQNN, k, Sec_clu_num):
    ...
    OPQ_data_path     = "./input/HNSWOPQ_with_OPQ_ver4/OPQ32_data/Sec_OPQ_data_{}.npy"
...
if __name__ == '__main__':
    ...
    for times in range(4):
        ...
        for i in range(query.shape[0]):
            total_D, total_I, HNSW_cost, PQ_cost, candidate, num = get_cand(I[i], query[i], OPQquery[i], PQNN, k, Sec_clu_num)
