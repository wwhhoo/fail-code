...
if __name__ == '__main__':
    ...
    # OPQdata = OPQMatrix.apply_py(OPQ_train)
    ...
    # HNSWOPQdata = HNSW_OPQMatrix.apply_py(HNSW_OPQ_train)
    np.save("./input/HNSWOPQ_with_OPQ_ver3.5/totalO_HNSW.npy", train_with_cent)
