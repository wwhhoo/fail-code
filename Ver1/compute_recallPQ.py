...
def get_cand( faiss_I, query, PQNN, k):
    ...
    if first:
        ...
        PQ_D, PQ_I, PQ_time_cost = PQ_cand(totalPQ_train_Data, totalPQ_train_ID, query, PQNN)
...
if __name__ == '__main__':
    ...
    for i in range(query.shape[0]):
        ...
        total_D, total_I, HNSW_cost, PQ_cost = get_cand(I[i], query[i], PQNN, k)
