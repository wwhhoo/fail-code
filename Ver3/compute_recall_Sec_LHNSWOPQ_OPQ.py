...
def get_cand( faiss_I, query, OPQquery, PQNN, k, Sec_clu_num):
    ...
    # OPQ_data_path = "./input/HNSWOPQ_with_OPQ_ver3/Sec_OPQ32_data/OPQ_data_{}_{}.npy"
    ...
    for i in faiss_I:
        ...
        if max(cand_ID) >= 1000000:
            ...
            OPQ_clu = cand_ID[pos[0]]

            OPQ_clu = OPQ_clu - 1000000 - i*1000#Sec_clu_num.shape[0]
        ...
        # total_D = np.concatenate((total_D,HNSW_D*1.035), axis=None)#
...
if __name__ == '__main__':
    ...
    for times in range(1):
        ...
        for i in range(query.shape[0]):
            ...
            total_D, total_I, HNSW_cost, PQ_cost, candidate, num = get_cand(I[i], HNSWquery[i], OPQquery[i], PQNN, k, Sec_clu_num)
