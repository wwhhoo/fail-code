...
if __name__ == '__main__':
    ...
    OPQ_save_path      = "./input/HNSWOPQ_with_OPQ_ver3.5/Kmeans_high_data/Sec_OPQ_data_{}.npy"
    OPQ_ID_save_path   = "./input/HNSWOPQ_with_OPQ_ver3.5/Kmeans_high_ID/Sec_OPQ_{}_ID.npy"
    Sec_HNSW_path      = './input/HNSWOPQ_with_OPQ_ver3.5/Kmeans_low_data/Sec_HNSW_{}.npy'
    Sec_HNSW_ID_path   = './input/HNSWOPQ_with_OPQ_ver3.5/Kmeans_low_ID/Sec_HNSW_{}_ID.npy'
    OPQ_centorid_path  = "./input/HNSWOPQ_with_OPQ_ver3.5/centroids/centroids_OPQ32/kmeans_centroids_{}.npy"
    HNSW_centorid_path = "./input/HNSWOPQ_with_OPQ_ver3.5/centroids/centroids_OPQ16/kmeans_centroids_{}.npy"
    centorid_path      = "./input/HNSWOPQ_with_OPQ_ver3.5/centroids/kmeans_centroids_{}.npy"
    Sec_clu_num_H_path = "./input/HNSWOPQ_with_OPQ_ver3.5/Second_cluster_data_num_H.npy"
    Sec_clu_num_L_path = "./input/HNSWOPQ_with_OPQ_ver3.5/Second_cluster_data_num_L.npy"
    Sec_clu_num_path   = "./input/HNSWOPQ_with_OPQ_ver3.5/Second_cluster_data_num.npy"
    ...
    top_centorid = np.zeros((LSC,d))
    end_centorid = np.zeros((HSC,d))
    ...
    np.save('./input/HNSWOPQ_with_OPQ_ver3.5/total_HNSW.npy',total_top50[:top_num])
    np.save('./input/HNSWOPQ_with_OPQ_ver3.5/total_OPQ.npy',total_end50[:end_num])
    np.save('./input/HNSWOPQ_with_OPQ_ver3.5/total_HNSW_ID.npy',total_top50_ID[:top_num])
    np.save('./input/HNSWOPQ_with_OPQ_ver3.5/total_OPQ_ID.npy',total_end50_ID[:end_num])
