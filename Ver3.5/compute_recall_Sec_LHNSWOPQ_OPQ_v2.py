...
Sec_clu_num = np.load("./input/HNSWOPQ_with_OPQ_ver3.5/Second_cluster_data_num.npy")
...
def get_cand( faiss_I, query, HNSWquery, OPQquery, PQNN, k, Sec_clu_num):
    ...
    OPQ_data_path = "./input/HNSWOPQ_with_OPQ_ver3.5/OPQ_data/Sec_OPQ_data_{}.npy"
    OPQ_ID_path   = "./input/HNSWOPQ_with_OPQ_ver3.5/OPQ_ID/Sec_OPQ_{}_ID.npy"
