...
#-----------
centorid = opq.apply_py(centorid)
np.save('./input/OPQ_centroids.npy', centorid)
#-----------
for i in range (C):
    ...
    #-----------
    # PQtrain[array_index:array_index+512] -= centorid[i]
    # array_index += 512
    #-----------
...
OPQindex_name = "./input/HNSW_with_PQ/OPQ_index/index_Residual_OPQ.index"
